...
?>
      <section>
        ...
        <article class="p-single--layout">
          <h2><?php echo esc_html(CFS()->get('h2')); ?></h2>
          <p><?php echo esc_html(CFS()->get('h2-text')); ?></p>
          <h3><?php echo esc_html(CFS()->get('h3')); ?></h3>
          <h4><?php echo esc_html(CFS()->get('h4')); ?></h4>
          <h5><?php echo esc_html(CFS()->get('h5')); ?></h5>
          <h6><?php echo esc_html(CFS()->get('h6')); ?></h6>
          ...
          <article class="p-flex--single">
            <img class="p-product--image--long" src="<?php echo esc_html(CFS()->get('main-menu-image')); ?>">
            <div class="p-flex--single-content"><!-- 写真とテキストを横並び -->
              <img class="p-product--image" src="<?php echo esc_html(CFS()->get('menu1--image')); ?>">
              <P><?php echo esc_html(CFS()->get('product-text1')); ?></P>
            </div>
            <div class="p-flex--single-content"><!-- 写真とテキストを横並び -->
              <img class="p-product--image" src="<?php echo esc_html(CFS()->get('menu2--image')); ?>">
              <P class="left"><?php echo esc_html(CFS()->get('product-text2')); ?></P>
            </div>
          </article>
